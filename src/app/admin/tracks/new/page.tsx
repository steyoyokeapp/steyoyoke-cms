...
export default async function NewTrackPage() {
  ...
  return <><Link className="back-link" href="/admin/tracks">← Tracks</Link><section className="page-heading"><div><div className="eyebrow">New draft</div><h1>Create Track</h1></div></section><TrackCreateForm artists={options.artists.map(({ id, name, legacyId }) => ({ id, name, legacyId }))} labels={options.labels} /></>;
}
